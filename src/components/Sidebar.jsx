  ...
  return (
    <div draggable onDragStart={e => onDragStart(e, eq)}
      ...
      <div style={{ display:"flex", justifyContent:"space-between", alignItems:"flex-start", marginBottom:2 }}>
        ...
        <span style={{ fontSize:10, background:"#2d3555", color:"#7a8ab0", border:"0.5px solid #3d4663",
          borderRadius:3, padding:"1px 5px", whiteSpace:"nowrap", marginLeft:6 }}>
          {eq.category}
        </span>
      </div>
...
export default function Sidebar({ blocks, onDragStart }) {
  ...
  const statusTooltip = {
    "built-in": "No local folder — using GitHub database",
    "github":   "No local folder — using GitHub database",
    connected:  "Local folder connected",
    syncing:    "Reading local folder...",
    saving:     "Saving to local folder...",
    error:      "Folder error — reconnect",
